...
@NamedQueries({
        ...
        @NamedQuery(name = "countGroupByName", query = "select count(*) from Group group where group.name = :name"),
        @NamedQuery(name = "findAllGroups", query = "select group from Group group")
})
@Entity
@Table(name = "classes")
public class Group {
