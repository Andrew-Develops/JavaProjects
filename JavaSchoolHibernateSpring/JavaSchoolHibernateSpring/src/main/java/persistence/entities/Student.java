...
@NamedQueries({
        ...
        @NamedQuery(name = "deleteStudentByName", query = "delete Student where firstName = :firstName and lastName = :lastName"),
        ...
        @NamedQuery(name = "countStudentByNameAndYearOfBirth", query = "select count(*) from Student student where student.firstName = :firstName and student.lastName = :lastName and student.yearOfBirth = :yearOfBirth")
})
@Entity
@Table(name = "student")
