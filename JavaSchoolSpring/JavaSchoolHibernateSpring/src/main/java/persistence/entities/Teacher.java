...
@NamedQueries({
        ...
        @NamedQuery(name = "deleteTeacherByName", query = "delete Teacher where firstName = :firstName and lastName = :lastName"),
        ...
        @NamedQuery(name = "countTeacherByName", query = "select count(*) from Teacher teacher where teacher.firstName = :firstName and teacher.lastName = :lastName")
